// Desa Persiapan Kiera Website - Core JS Application
...
const FALLBACK_DATA = {
  ...
  "profil": {
    "sejarah": "Desa Persiapan Kiera adalah sebuah desa yang tengah dalam proses pembentukan dan pengembangan, dengan tekad kuat membangun masyarakat yang sejahtera, berkeadilan, dan berwawasan ke depan.",
    "visi": "Terwujudnya Desa Persiapan Kiera sebagai pusat pelayanan publik yang prima, mandiri, unggul, dan berbudaya berbasis potensi lokal demi kesejahteraan masyarakat yang berkeadilan.",
    "misi": [
      "Meningkatkan kualitas pelayanan administrasi desa secara cepat, akurat, transparan, dan berbasis teknologi informasi.",
      "Mengembangkan ekonomi kreatif dan memberdayakan masyarakat desa berbasis potensi kelautan, pertanian sabana, dan perdagangan lokal.",
  ...
  "aparatur": [
    { "id": 1, "nama": "Ronal Marcus, S.STP", "jabatan": "Kepala Desa Persiapan Kiera", "avatar_color": "#1b4332" },
    { "id": 2, "nama": "Helena Frans, S.Sos", "jabatan": "Sekretaris Desa Persiapan Kiera", "avatar_color": "#2d6a4f" },
    { "id": 3, "nama": "Jhonny Letelay, A.Md", "jabatan": "Kasi Pemerintahan & Ketertiban Umum", "avatar_color": "#40916c" },
    { "id": 4, "nama": "Maria O. Keliwulan, S.E", "jabatan": "Kasi Kesejahteraan Rakyat & Pelayanan", "avatar_color": "#52b788" }
  ],
...
// Palette Colors for Charts (Foliage / Nature Green)
const chartColors = {
  greenForest: ['#1b4332', '#2d6a4f', '#40916c', '#52b788', '#74c69d', '#95d5b2'],
  blueOcean: ['#2d6a4f', '#40916c', '#52b788', '#74c69d', '#95d5b2', '#b7e4c7'],
  goldAmber: ['#52b788', '#74c69d', '#95d5b2', '#b7e4c7', '#d8f3dc'],
  mixedGov: ['#1b4332', '#2d6a4f', '#40916c', '#52b788', '#74c69d', '#95d5b2', '#b7e4c7']
};
  ...
  container.innerHTML = `
    <section class="hero">
      <div class="hero-content">
        ...
        <h1 class="hero-title">Selamat Datang di Portal Resmi<br><span>Desa Persiapan Kiera</span></h1>
    ...
    <section class="section-container">
      <div class="welcome-section">
        <div class="welcome-text">
          <h2>Selamat Datang di Desa Persiapan Kiera</h2>
          <p>Desa Persiapan Kiera senantiasa berupaya memberikan informasi publik yang informatif, transparan, dan akuntabel kepada segenap masyarakat. Kami berkomitmen untuk mendayagunakan kemajuan teknologi informasi demi kelancaran administrasi desa dan mempererat persatuan masyarakat.</p>
          <div class="welcome-quote">
            "Menghidupkan kebersamaan dan kekeluargaan dalam semangat adat Kalwedo demi kemajuan Desa Persiapan Kiera."
          </div>
        ...
        <div class="welcome-image-container">
          <div class="welcome-img-card">
            ...
            <img src="https://images.unsplash.com/photo-1542224566-6e85f2e6772f?auto=format&fit=crop&w=600&q=80" alt="Landscape Desa Persiapan Kiera">
            <div class="img-overlay-badge">
              <span>Desa Persiapan</span>
              Kiera - Maluku Barat Daya
            </div>
          </div>
        </div>
      </div>
  ...
  container.innerHTML = `
    <div class="section-container">
      <div class="section-title-wrapper">
        <h1 class="section-title">Profil Desa Persiapan Kiera</h1>
        <p class="section-subtitle">Mengenal sejarah, nilai dasar kepemimpinan, visi misi, dan jajaran kepengurusan Desa Persiapan Kiera.</p>
      </div>
      ...
      <div class="section-title-wrapper" style="margin-top: 5rem; margin-bottom: 3rem;">
        <h2 class="section-title" style="font-size: 1.75rem;">Aparatur Desa Persiapan Kiera</h2>
        <p class="section-subtitle">Dedikasi jajaran perangkat Desa Persiapan Kiera untuk melayani kebutuhan administratif dan sosial masyarakat.</p>
      </div>
...
function renderTransparansi(container) {
  ...
  container.innerHTML = `
    <div class="section-container">
      <div class="section-title-wrapper">
        ...
        <p class="section-subtitle">Realisasi Anggaran Pendapatan dan Belanja (APB) Desa Persiapan Kiera Tahun Anggaran ${appData.transparansi_anggaran.tahun}.</p>
      </div>
      ...
      <div class="budget-overview">
        ...
        <div class="budget-summary-box">
          <div class="summary-card">
            <div class="summary-title">Total Pendapatan Desa Persiapan Kiera</div>
            <div class="summary-amount">${formatRupiah(totalPendapatan)}</div>
          </div>
          
          <div class="summary-card expense">
            <div class="summary-title">Total Belanja Desa Persiapan Kiera</div>
  ...
  currentCharts['budget'] = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        label: 'Anggaran Desa Persiapan Kiera (Rupiah)',
...
function downloadExcelReport() {
  ...
  // Title info
  sheetData.push(["LAPORAN DATA STATISTIK RESMI Desa Persiapan Kiera"]);
  ...
  XLSX.utils.book_append_sheet(wb, ws, "Statistik Desa Persiapan Kiera");
  XLSX.writeFile(wb, "Laporan_Statistik_Desa_Persiapan_Kiera.xlsx");
}
  ...
  container.innerHTML = `
    <div class="statistik-page-wrapper">
      ...
      <div class="section-title-wrapper" style="display: flex; flex-direction: column; align-items: center; gap: 1rem;">
        ...
        <p class="section-subtitle">Visualisasi terperinci mengenai kependudukan, sarana prasarana, agama, dan data profil warga Desa Persiapan Kiera.</p>
      ...
      <div class="stats-highlight-row">
        <div class="stats-card-main">
          <div class="stats-main-info">
            <h3>Jumlah Penduduk Desa Persiapan Kiera</h3>
...
function renderStatCharts() {
  ...
  // Natural Foliage Green Colors (Deep Forest, Emerald, Fern, Jade, Leaf Sprout)
  const genderColors = ['#2d6a4f', '#74c69d']; // Forest Leaf vs Bright Spring Sprout
  const maritalColors = ['#1b4332', '#40916c', '#74c69d', '#b7e4c7'];
  const jobColors = ['#1b4332', '#2d6a4f', '#40916c', '#52b788', '#74c69d', '#95d5b2'];
  const religionColors = ['#1b4332', '#2d6a4f', '#52b788', '#95d5b2', '#d8f3dc'];
  const educationColors = ['#2d6a4f', '#40916c', '#52b788', '#74c69d', '#b7e4c7'];
  const healthColors = ['#081c15', '#1b4332', '#2d6a4f', '#40916c', '#52b788', '#74c69d', '#95d5b2', '#b7e4c7', '#d8f3dc'];
...
function renderAdminLogin(container) {
  container.innerHTML = `
    <div class="section-container">
      <div class="admin-login-container">
        ...
        <p>Gunakan Kode Unik Desa untuk masuk dan mengelola konten serta data statistik kependudukan.</p>
  ...
  form.addEventListener('submit', async (e) => {
    ...
    if (inputHash === targetHash) {
      ...
      alert('Login berhasil! Selamat datang di Panel Admin Desa Persiapan Kiera.');
      router(); // Refresh view
    } else {
        ...
        <main class="admin-content-area">
          ...
          <div class="admin-content-section active" id="admin-tab-profil">
            <div class="admin-section-header">
              <h2>Profil & Aparatur Desa</h2>
            </div>
            
            <div class="form-group">
              <label for="edit-sejarah">Sejarah Desa</label>
              <textarea id="edit-sejarah" class="form-input" rows="5" style="resize:vertical;"></textarea>
            </div>
            
            <div class="form-group">
              <label for="edit-visi">Visi Desa</label>
              <input type="text" id="edit-visi" class="form-input">
            </div>

            <div class="form-group">
              <label>Misi Desa (Pisahkan per baris)</label>
              <textarea id="edit-misi" class="form-input" rows="4" style="resize:vertical;"></textarea>
            </div>

            <div class="form-group" style="margin-top: 2rem;">
              <label style="border-bottom: 2px solid var(--border-light); padding-bottom: 0.5rem; display: block; margin-bottom: 1rem;">Daftar Aparatur Desa</label>
          ...
          <div class="admin-content-section" id="admin-tab-anggaran">
            <div class="admin-section-header">
              <h2>Transparansi Anggaran Desa (APBDes)</h2>
            </div>
            ...
            <div class="form-group" style="margin-top: 1.5rem;">
              <label style="border-bottom: 2px solid var(--border-light); padding-bottom: 0.5rem; display: block; margin-bottom: 1rem;">Pos Pendapatan Desa</label>
            ...
            <div class="form-group" style="margin-top: 2rem;">
              <label style="border-bottom: 2px solid var(--border-light); padding-bottom: 0.5rem; display: block; margin-bottom: 1rem;">Pos Pembelanjaan Desa</label>
          ...
          <div class="admin-content-section" id="admin-tab-github">
            ...
            <div class="admin-form-grid">
              ...
              <div class="form-group">
                ...
                <input type="text" id="gh-repo" class="form-input" placeholder="Contoh: website-desa-kiera">
              </div>
              <div class="form-group">
...
function populateAdminForm() {
  ...
  if (window.location.hostname.endsWith('.github.io')) {
    ...
    if (!detectedRepo && pathParts.length > 0) {
      detectedRepo = pathParts[0]; // e.g. "Desa-Persiapan-Kiera"
    }
  }
...
function compileFormData() {
  ...
  const newAparatur = [];
  const palette = ['#1b4332', '#2d6a4f', '#40916c', '#52b788', '#74c69d', '#95d5b2', '#2c6e49'];
